...
def log_gate_run(
    ...
    """
    Log a Quality Gate run event to the JSONL file.
    
    Format: timestamp, project, event_type="GATE_RUN", gate_passed, security_mode, trace_id
    """
    ensure_log_dir()
    ...
    try:
        ...
        print(f"Error writing to gate log: {e}")
